...
/
CALL CREA_PACIENTE('Miguel','Rodriguez','1234','1234','Resfriado','Frenadol',to_date('01/01/2015','DD/MM/YYYY'),3);
...
/
CALL CREA_MONITOR_ENSAYO('Ana','Garrido',666555444,'ana@gmail.com',3,1);
/
...
/
CALL CREA_EMPLEADO('Manuel','Ordoñez','12345678A',666555444,'manuel@gmail.com');
/
...
(ID_EC_OLD IN TRABAJA_EN.ID_EC%TYPE,
 ID_EMP_OLD IN TRABAJA_EN.ID_EMP%TYPE,
...
BEGIN
  ...
  SET ID_EC=ID_EC_A_MOD, ID_EMP=ID_EMP_A_MOD, 
	CARGO=CARGO_A_MOD
  WHERE ID_EC = ID_EC_OLD AND ID_EMP = ID_EMP_OLD;
  COMMIT WORK;
